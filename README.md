...
## Descrição
O projeto foi construído inteiramente com HTML, CSS e JavaScript *puros*!!!
Pode ser acessado [neste link do GitHub Pages](https://mdeloko.github.io/projeto-convalidacao-web-frontend/).
